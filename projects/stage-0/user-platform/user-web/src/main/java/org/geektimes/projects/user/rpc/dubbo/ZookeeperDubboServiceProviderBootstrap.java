...
import org.geektimes.projects.user.service.EchoServiceImpl;
...
//                        .parameter(REGISTRY_TYPE_KEY, SERVICE_REGISTRY_TYPE)
                ...
                .service("echo", builder -> builder.interfaceClass(EchoService.class).ref(new EchoServiceImpl()).protocolIds("dubbo,rest"))
                .start()
                .await();
    }
}
